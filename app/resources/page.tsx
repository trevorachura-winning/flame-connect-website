...
export default async function ResourcesPage({
  ...
  const active = ARTICLE_CATEGORIES.find((c) => c === category) ?? null;
  const articles = sortedArticles().filter((a) => !active || a.category === active);
  ...
  return (
    <>
      ...
      {/* Case studies & events — honest placeholders per the brief */}
